                ...
                <div className={styles.chatArea}>
                    <div className={styles.chatHeader}>
                        ...
                        <div className={styles.chatHeaderAction}>
                            <button onClick={() => setTab('CHATROOM')}>Chatroom</button>
                    ...
                    <div className={styles.chatContent}>
                        {tab === 'CHATROOM' ? (
                            <div className={styles.chatContentBox}>
                                {publicChat.map((chat) => (
                                    <div key={chat.id} className={styles.chatContentItem}>
                                        <div className={styles.chatContentItemSender}>{chat.senderName}</div>
                                        <div className={styles.chatContentItemMessage}>{chat.message}</div>
                                    </div>
                                ))}
                            </div>
